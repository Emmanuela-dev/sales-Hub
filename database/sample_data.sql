...
-- ============================================================
-- USERS
-- Generate real hash: py -c "import bcrypt; print(bcrypt.hashpw(b'admin123', bcrypt.gensalt()).decode())"
-- Then: UPDATE users SET password_hash='<hash>' WHERE is_active=TRUE;
-- ============================================================
INSERT INTO users (username, full_name, email, phone, password_hash, role) VALUES
('owner',   'Amina Wanjiku',  'amina@glamourhub.co.ke',  '0722 001 001', '$2b$12$REPLACE_WITH_REAL_HASH', 'Owner'),
('manager', 'Grace Njeri',    'grace@glamourhub.co.ke',  '0711 001 002', '$2b$12$REPLACE_WITH_REAL_HASH', 'Manager'),
('staff1',  'Beatrice Auma',  'bea@glamourhub.co.ke',    '0700 001 003', '$2b$12$REPLACE_WITH_REAL_HASH', 'Staff'),
('staff2',  'Sharon Chebet',  'sharon@glamourhub.co.ke', '0733 001 004', '$2b$12$REPLACE_WITH_REAL_HASH', 'Staff');
...
--   py -c "import bcrypt; print(bcrypt.hashpw(b'admin123', bcrypt.gensalt()).decode())"
